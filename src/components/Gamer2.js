...
import { useGLTF, SpotLight, useVideoTexture, useTexture, useAspect, Html } from '@react-three/drei';
...
// Monitors
import MainMonitor from './MonitorMain'
...
export default function Gamer(props) {
    ...
    const { nodes, materials } = useGLTF("./models/gamer2.glb");
    ...
    const wall_monitor_group_ref = useRef();
    ...
    useAnimateGroup(wall_group_ref, { range: 20, min: 10, duration: 2, resetTargetY: 0 });

    useAnimateGroup(desk_group_ref, { range: 20, min: 10, duration: 2.3, resetTargetY: 0 });
    useAnimateGroup(monitor_group_ref, { range: 21, min: 20, duration: 2.4, resetTargetY: 0 });
    useAnimateGroup(couch_group_ref, { range: 30, min: 20, duration: 2.5, resetTargetY: 0 });
    useAnimateGroup(wall_monitor_group_ref, { range: 30, min: 20, duration: 2.6, resetTargetY: 0 });
        ...
        <group {...props} dispose={null} scale={1}>
            ...
            <group ref={wall_monitor_group_ref}>
                ...
                <mesh geometry={nodes.center_monitor.geometry} material={nodes.center_monitor.material}>
                    {/* <Html className="content" transform rotation-y={-Math.PI} position={[0, 1.15, 4.5]} occlude scale={0.2}>
